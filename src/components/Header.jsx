...
const Header = (prop) => {
  ...
  const resizeCallback = useCallback(() => {
    ...
    setLogo(
      window.innerWidth < 400
        ? "../img/core-img/Logo1.png"
        : "../img/core-img/gxlogo.png"
    );
  }, [setLogo]);
  ...
  const toggleSubMenu = (index, e) => {
    ...
    if (window.innerWidth < 1450) {
      for (let i = 0; i < navbarItem.current.children.length; i++) {
        if (
          i === index &&
          !navbarItem.current.children[i].classList.contains("active")
        ) {
          navbarItem.current.children[i].classList.add("active");
          navbarItem.current.children[i].children[1].setAttribute(
            "style",
  ...
  const displayModal = (e, title, content) => {
    if (
      !sessionStorage.hasOwnProperty("showDonationInst") ||
      sessionStorage.getItem("showDonationInst") === "true"
    ) {
      e.preventDefault();
      setShow(true);
      setContent({
                ...
                <div className="top-header-meta d-flex flex-wrap">
                  <div>
                    <div id="translation-button">
                      <button id="vn" onClick={() => setLanguageVN()}>
                        VN
                      </button>
                      <button id="en" onClick={() => setLanguageEN()}>
                        EN
                      </button>
                    </div>
                  </div>
                  <div className="top-social-info">
                    <a
                      ...
                      aria-label="facebook"
                    >
                      <i className="fab fa-facebook" ref={facebook}></i>
                    </a>
                    <a
                      href="https://www.youtube.com/thanhtudaovietnam"
                      aria-label="youtube"
                    >
                      <i className="fab fa-youtube" ref={youtube}></i>
                    </a>
                    <a
                      href="https://twitter.com/thanhtudaovn"
                      aria-label="twitter"
                    >
                      <i className="fab fa-twitter" ref={twitter}></i>
                    </a>
                  </div>
                </div>
                <div className="top-header-meta">
                  ...
                  <a href="/massSchedule" className="email-address">
                    <i
                      ...
                      ref={massSchedule}
                    ></i>
                    <span>{t("header.top.massSchedule")}</span>
                  </a>
                  <a href="mailto:info@hvmatl.org" className="email-address">
                    <i
                      className="fas fa-envelope"
                      aria-hidden="true"
                      ref={email}
                    ></i>{" "}
                    <span>info@hvmatl.org</span>
                  </a>
                  <a href="tel:770-921-0077" className="phone">
                    <i
                      className="fas fa-phone"
                      aria-hidden="true"
                      ref={phone}
                    ></i>{" "}
                    <span>770-921-0077</span>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="classy-nav-container breakpoint-off" ref={navbar}>
            <div className="container">
              ...
              >
                ...
                >
                  <a
                    href="https://giving.parishsoft.com/App/Giving/holy4545250"
                    className="crose-btn"
                    onClick={(e) =>
                      displayModal(
                        e,
                        "Huong dan Donation",
                        "img/core-img/donation_instruction.jpg"
                      )
                    }
                  >
                    <i className="fas fa-donate" /> DONATION
                  </a>
                  <span className="navbarToggler" ref={navbarToggler}>
                    <span />
                    <span />
                    <span />
                  </span>
                ...
                >
                  <div className="classycloseIcon">
                    <div className="cross-wrap" ref={navbarClose}>
                      <span className="top" />
                      <span className="bottom" />
>>>>>>> cttdvnatl-repo/master
                    </div>
                  </div>
                  <div className="classynav">
                    <ul ref={navbarItem}>
                      ...
                      >
                        <a href="/#">
                          {t("header.dropdownMenuOne.dropdownHeading")}
                        </a>
                        <ul className="dropdown">
                          <li>
                            <a href="/">{t("header.dropdownMenuOne.item1")}</a>
                          </li>
                          <li>
                            <a href="/about">
                              {t("header.dropdownMenuOne.item2")}
                            </a>
                          </li>
                          <li>
                            <a href="/history">
                              {t("header.dropdownMenuOne.item3")}
                            </a>
                          </li>
                          <li>
                            <a href="/saint">
                              {t("header.dropdownMenuOne.item4")}
                            </a>
                          </li>
                          <li>
                            <a href="/clergy-list">
                              {t("header.dropdownMenuOne.item5")}
                            </a>
                          </li>
                          <li>
                            <a href="/staff">
                              {t("header.dropdownMenuOne.item6")}
                            </a>
                          </li>
                        </ul>
                        <span className="dd-trigger" />
                      ...
                      >
                        <a href="/#">
                          {t("header.dropdownMenuTwo.dropdownHeading")}
                        </a>
                        <ul className="dropdown">
                          <li>
                            <a href="/activities">
                              {t("header.dropdownMenuTwo.item1")}
                            </a>
                          </li>
                          <li>
                            <a href="/printed-calendar">
                              {t("header.dropdownMenuTwo.item2")}
                            </a>
                          </li>
                          <li>
                            <a href="/fall-fest">
                              {t("header.dropdownMenuTwo.item3")}
                            </a>
                          </li>
                          <li>
                            <a href="/thieu-nhi">
                              {t("header.dropdownMenuTwo.item4")}
                            </a>
                          </li>
                        </ul>
                        <span className="dd-trigger" />
                      ...
                      >
                        <a href="/#">
                          {t("header.dropdownMenuThree.dropdownHeading")}
                        </a>
                        <ul className="dropdown">
                          <li>
                            <a href="/Org">
                              {t("header.dropdownMenuThree.item1")}
                            </a>
                          </li>
                          <li>
                            <a href="/departments/KCS">
                              {t("header.dropdownMenuThree.item2")}
                            </a>
                          </li>
                          <li>
                            <a href="/departments/KDS">
                              {t("header.dropdownMenuThree.item3")}
                            </a>
                          </li>
                          <li className="KGD">
                            <a href="/departments/KGD">
                              {t("header.dropdownMenuThree.item4")}
                            </a>
                            <ul>
                              <li>
                                <a href="/st-joseph">
                                  {t("header.dropdownMenuThree.subItem1")}
                                </a>
                              </li>
                              <li>
                                <a href="/VietHong">
                                  <i>
                                    {t("header.dropdownMenuThree.subItem2")}
                                  </i>
                                </a>
                              </li>
                            </ul>
                          ...
                          <li>
                            <a href="/departments/KHC">
                              {t("header.dropdownMenuThree.item5")}
                            </a>
                          </li>
                          <li>
                            <a href="/departments/KPT">
                              {t("header.dropdownMenuThree.item6")}
                            </a>
                          </li>
                          <li>
                            <a href="/departments/KTG">
                              {t("header.dropdownMenuThree.item7")}
                            </a>
                          </li>
                          <li>
                            <a href="/departments/KQT">
                              {t("header.dropdownMenuThree.item8")}
                            </a>
                          </li>
                          <li>
                            <a href="/departments/KGQ">
                              {t("header.dropdownMenuThree.item9")}
                            </a>
                          </li>
                        </ul>
                        <span className="dd-trigger"></span>
                      ...
                      >
                        <a href="/#">
                          {t("header.dropdownMenuFour.dropdownHeading")}
                        </a>
                        <ul className="dropdown">
                          <li>
                            <a href="/weeklyNews">
                              {t("header.dropdownMenuFour.item1")}
                            </a>
                          </li>
                          <li>
                            <a href="/Articles">
                              {t("header.dropdownMenuFour.item2")}
                            </a>
                          </li>
                          <li>
                            <a href="/catholic_teaching">
                              {t("header.dropdownMenuFour.item3")}
                            </a>
                          </li>
                          <li>
                            <a href="/photos">
                              {t("header.dropdownMenuFour.item4")}
                            </a>
                          </li>
                          <li>
                            <a href="/forms">
                              {t("header.dropdownMenuFour.item5")}
                            </a>
                          </li>
                          <li>
                            <a href="/PrayerRequest">
                              {t("header.dropdownMenuFour.item6")}
                            </a>
                          </li>
                        </ul>
                        <span className="dd-trigger" />
                      ...
                      <li>
                        <a href="/contact">
                          {t("header.dropdownMenuFive.dropdownHeading")}
                        </a>
                      </li>
                    </ul>
                    <a
                      href="https://giving.parishsoft.com/App/Giving/holy4545250"
                      className="crose-btn header-btn"
                      onClick={(e) =>
                        displayModal(
                          e,
                          "Huong dan Donation",
                    ...
                    >
                      <i className="fas fa-donate" /> {t("header.donation")}
                    </a>
                  </div>
                </div>
              </nav>
            ...
            <EmergencyEvent
              emergency={"emergency" in prop ? prop.emergency : false}
              message={prop.emergencyMsg}
              url={prop.url}
            />
          </div>
        </div>
      ...
      {show ? (
        <PopupModal show={show} content={content} onHide={hideModal} />
      ) : null}
    </header>
  );
};
